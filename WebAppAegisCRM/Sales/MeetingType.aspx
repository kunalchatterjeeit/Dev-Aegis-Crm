<%@ Page Title="MEETING TYPE" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MeetingType.aspx.cs" Inherits="WebAppAegisCRM.Sales.MeetingType" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <center>
                                    <asp:GridView ID="gvMeetingType" runat="server" Width="100%" AutoGenerateColumns="false" class="table table-striped"
                                        GridLines="None" AllowPaging="false" CellPadding="0" CellSpacing="0" DataKeyNames="Id" ForeColor="#333333" OnRowCommand="gvMeetingType_RowCommand">
                                        <Columns>
