<%@ Page Title="PROBLEM OBSERVED" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ActionTaken.aspx.cs" Inherits="WebAppAegisCRM.Service.ActionTaken" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <center>
                            <asp:GridView ID="gvActionTaken" DataKeyNames="Id" runat="server" AutoGenerateColumns="false"
                                Width="50%" CellPadding="4" EnableModelValidation="True" ForeColor="#333333"
                                GridLines="None" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="gvActionTaken_PageIndexChanging"
                                PageSize="12" class="table table-striped" OnRowCommand="gvActionTaken_RowCommand">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            SN.</HeaderTemplate>
