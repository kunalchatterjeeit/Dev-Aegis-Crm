                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtNewPassword" runat="server" class="form-control" autofocus></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:Label ID="lblReNewPassword" runat="server" Text="Re-enter password"></asp:Label>
                                            <asp:TextBox ID="txtReNewPassword" TextMode="Password" runat="server" class="form-control"></asp:TextBox>
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password & Re-enter password should be same" ControlToValidate="txtNewPassword" ValueToCompare="txtNewPassword" ControlToCompare="txtReNewPassword" ForeColor="Red"></asp:CompareValidator>
                                        </div>
                                            ...
                                            ForeColor="Red" />
                                        <div class="checkbox">
                                            <span id="lblMessage" runat="server" style="color: blue;"></span>
                                        </div>
                                        <!-- Change this to a button or input when using this as a form -->
                                        <asp:Button ID="btnChange" runat="server" Text="Change" class="btn btn-lg btn-success btn-block"
